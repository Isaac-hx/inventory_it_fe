        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-2">
            ...
            <Card className="rounded-md shadow-sm">
              <CardHeader>
                <CardTitle className="flex text-primary items-center gap-2 text-base font-bold md:text-md">
            ...
            <div className="space-y-6">
              <Card className="rounded-md shadow-sm">
                <CardHeader>
                  <CardTitle className="flex text-primary items-center gap-2 text-base font-bold md:text-sm">
              ...
              <Card className="rounded-md shadow-sm">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-primary font-bold md:text-sm">
